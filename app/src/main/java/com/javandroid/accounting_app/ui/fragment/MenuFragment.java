        ...
        public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
                ...
                btnNewOrder.setOnClickListener(
                                v -> Navigation.findNavController(v)
                                                .navigate(R.id.action_menuFragment_to_scanOrderFragment));

                btnViewOrders.setOnClickListener(
                                v -> Navigation.findNavController(v)
                                                .navigate(R.id.action_menuFragment_to_orderEditorFragment));

                btnProducts.setOnClickListener(
                                v -> Navigation.findNavController(v)
                                                .navigate(R.id.action_menuFragment_to_productEditorFragment));

                btnCustomers.setOnClickListener(
                                v -> Navigation.findNavController(v)
                                                .navigate(R.id.action_menuFragment_to_customerListFragment));
        }
}
